...
namespace VirtualLens2
{
    internal class ImplementationSettings
    {
        ...
        public bool DroneQuickTurnEnabled { get; }
        public bool DroneZoomEnabled { get; }
        ...
        public float DefaultGridOpacity { get; }
        ...
        // Algorithm Settings
        public InternalResolution DefaultResolution { get; } 
        ...
        public ImplementationSettings(VirtualLensSettings settings)
        {
            ...
            DroneQuickTurnEnabled = settings.enableDroneQuickTurn;
            DroneZoomEnabled = settings.enableDroneZoom;
            // Clipping Planes
            ...
            CustomGrids = settings.customGrids
                ...
                .ToImmutableList();
            DefaultGridOpacity = settings.initialGridOpacity;
