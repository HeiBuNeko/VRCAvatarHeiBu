...
namespace VirtualLens2.AV3EditorLib
{
    ...
    public class ArtifactsFolder
    {
        ...
        /// <summary>
        /// Initializes with a reference to the asset container.
        /// </summary>
        /// <param name="container">The reference to the asset container to save assets.</param>
        public ArtifactsFolder(UnityEngine.Object container)
        {
            Path = null;
        ...
        /// <summary>
        /// Returns the asset container object.
        /// </summary>
        [CanBeNull]
        ...
        {
            if (Path == null && AssetContainer == null) { return; }
            if (Path == null)
            {
