...
namespace VirtualLens2
{
    ...
    public class VirtualLensSettings : MonoBehaviour, IEditorOnly
    {
        ...
        [SerializeField] public bool enableDroneQuickTurn = true;
        [SerializeField] public bool enableDroneZoom = true;
        ...
        [SerializeField] public float initialGridOpacity = 1.0f;
        ...
        [SerializeField] public InternalResolution defaultResolution = InternalResolution.Resolution1080p;
        ...
        // Obsolete in v2.12.0. Kept for migration.
