Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/8c037ef828cd98b4493cacde9c5464cd"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float alphaMask = POI2D_SAMPLER_PAN(_ClippingMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_ClippingMaskUV*/)], float4(1,0,0,0)), float4(-1,0,0,0)).r;
