    ...
    public class SetupHelper : EditorWindow
    {
        ...
        public static void NonDestructiveInitialize()
        {
            EditorUtility.DisplayDialog(
                "VirtualLens2",
                "Non-destructive setup requires Modular Avatar.\nPlease import it before starting setup.",
                "OK");
        }
#endif
        ...
        public static void DestructiveInitialize()
        {
            ...
            if (!EditorUtility.DisplayDialog(
                    "VirtualLens2",
                    "Non-destructive setup is available for this project.\nDo you really want to use a destructive setup?",
                    "Yes", "No"))
            {
                return;
            }
        ...
        private bool HasCameraModel(GameObject obj)
        {
            if (obj == null) { return false; }
            var settings = obj.GetComponent<VirtualLensSettings>();
            if (settings == null) { return false; }
            return settings.cameraObject != null;
        }
        ...
        private bool ValidateSettings()
        {
            ...
            {
                EditorGUILayout.HelpBox(
                    "Settings template contains a camera model, which will be used instead of generating a new one.",
                    MessageType.Info);
            }
        ...
        private void Apply()
        {
            ...
            // Put camera model
            if (component.cameraObject == null)
            {
