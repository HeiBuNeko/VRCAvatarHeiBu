#ifndef VIRTUALLENS2_LOGIBOKEH_UNIFIED_FULL_COMPOSITION_CGINC
#define VIRTUALLENS2_LOGIBOKEH_UNIFIED_FULL_COMPOSITION_CGINC
...
v2f vertex(appdata v){
	...
	if(!isVRChatCameraHighResolution()){
		o.vertex = 0;
		o.uv     = 0;
		o.params = 0;
		return o;
...
float4 fragment(v2f i) : SV_Target {
	...
	const float3 rgb = (_Blurring > 0.0)
		? exposure * composition(num_rings, computePaddedUV(i.uv))
