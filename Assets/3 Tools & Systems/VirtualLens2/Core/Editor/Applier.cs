...
namespace VirtualLens2
{
    internal static class Applier
    {
        ...
        public static void Apply(ImplementationSettings settings, UnityEngine.Object assetContainer = null)
        {
            ...
            try
            {
                ...
                var folder = assetContainer != null
                    ? new ArtifactsFolder(assetContainer)
                    : new ArtifactsFolder(settings.ArtifactsFolder);
