Shader "VirtualLens2/System/DisplayRenderer"
{
	Properties
	{
		...
		_GridType         ("Grid Type",           Float) = 0.0
		_GridOpacity      ("Grid Opacity",        Float) = 1.0
		_ShowInfo         ("Show Information",    Float) = 0.0
		_ShowLevel        ("Show Level",          Float) = 0.0
		_PeakingMode      ("Peaking Mode",        Float) = 0.0
		_CursorType       ("Cursor Type",         Float) = 0.0
		_HorizontalFlip   ("Horizontal Flip",     Float) = 0.0
		_Resolution       ("Internal Resolution", Float) = 0.0
		_AFMode           ("AF Mode",             Float) = 0.0
		_FarOverride      ("Far Plane Override",  Float) = 0.0
		_DepthEnabler     ("Depth Enabler",       Float) = 0.0
